...
const SidebarComponent = ({ isSidebarVisible, setSidebarVisible }) => {
  ...
  return (
    <>
      ...
      {isSidebarVisible &&
        <aside className="fixed z-50 bg-[#151618] top-0 left-0  w-[100vw] h-[100vh]  rounded-[12px] py-4 pl-4  flex flex-col gap-3 text-white">
          <div className="flex justify-center mt-2 w-full">
            <div className=" p-3 bg-[#2FFE823D] border border-[#2FFE82] rounded-[18px] ">
          ...
          <button className="absolute bottom-[10px] flex py-1 flex px-2 justify-start w-[90%] items-center rounded-[10px] border-[#DB4831] bg-[#DB48313D] border-[1px]">
            <img className="mr-2" src={`/assets/images/icons/logoutIcon.svg`} />
            <p className=" ml-2 font-bold text-[#DB4831]">Sair</p>
          </button>
        </aside>}
