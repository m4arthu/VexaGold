            ...
            <div class="">
                <div class="flex mt-2 flex w-full justify-between">
                    <div className="flex gap-3">
                        ...
                        <div className="flex items-center justify-between px-3 w-[320px] rounded-[15px] bg-[#151618]">
                    ...
                    <select class="ppearance-none text-white font-bold  w-[150px] bg-[#151618] text-[14px] text-white  rounded-[15px] custom-select  px-3">
